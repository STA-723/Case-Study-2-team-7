...
AB_NYC_2019_0out$availability_365 <- ifelse(AB_NYC_2019_0out$availability_365 <= 60,"Low", AB_NYC_2019_0out$availability_365)

AB_NYC_2019_0out$availability_365 <- ifelse(AB_NYC_2019_0out$availability_365 >60 & AB_NYC_2019_0out$availability_365 <=180,"Median", AB_NYC_2019_0out$availability_365)

AB_NYC_2019_0out$availability_365 <- ifelse(AB_NYC_2019_0out$availability_365 >180,"High", AB_NYC_2019_0out$availability_365)
...
mod.lm_freq_other<- lm(log(price+0.01)~.,data=tdm2_other)
...
AB_NYC_2019$name[grep("sonder", AB_NYC_2019$name, ignore.case=TRUE)]
```

### popularity
```{r}
mod.lm_freq_other<- lm(log(reviews_per_month_ori+0.01)~.,data=tdm2_other)
coef_other<- summary(mod.lm_freq_other)
coef_other<- as.data.frame(coef_other$coefficients)


coef_other_sort<- coef_other[order(coef_other$`t value`, decreasing = T),]
coef_other_sort[1:20,]

st_coef_other<- lm.beta(mod.lm_freq_other)
st_coef_other$standardized.coefficients[order(st_coef_other$standardized.coefficients, decreasing = T)[1:20]] 

### check the original names which include the important words
AB_NYC_2019$name[grep("garden-midtown1stop-breakfast", AB_NYC_2019$name, ignore.case=TRUE)]
